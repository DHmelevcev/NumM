...
void Cubic_Interpolation_Spline_1d::update(const std::vector<double>& points, const std::vector<double>& values)
{
	knots.clear();
...
double Cubic_Interpolation_Spline_1d::get_value(const double point, int derivitive) const
{
	double res = 0;
	double eps = 1e-7;
